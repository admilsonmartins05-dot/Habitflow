  ...
  useEffect(() => {
    const loadHabit = async () => {
      ...
      if (data) {
        ...
        setEmoji(data.emoji)
        setColor(data.color)
        setFrequencyType(data.frequency_type as FrequencyType)
        setFrequencyDays(data.frequency_days)
        setTimesPerWeek(data.frequency_times_per_week)
        setDurationWeeks(data.duration_weeks)
        setTimeOfDay(data.time_of_day as TimeOfDay)
  ...
  if (loading) {
    return (
      <div style={{ maxWidth: 520, margin: '0 auto', padding: '32px 0', textAlign: 'center' }}>
        ...
        <p style={{ marginTop: 12, color: 'var(--text-secondary)' }}>Carregando hábito...</p>
      </div>
    )
  }
  ...
  const renderStep = () => {
    switch (step) {
      case 0:
        return (
          <div>
            <h2 style={{ fontSize: 24, fontWeight: 800, marginBottom: 8 }}>Editar nome do hábito</h2>
      ...
      case 1:
        return (
          <div>
            <h2 style={{ fontSize: 24, fontWeight: 800, marginBottom: 8 }}>Editar Frequência</h2>
            <p style={{ color: 'var(--text-secondary)', fontSize: 15, marginBottom: 28 }}>
      ...
      case 2:
        return (
          <div>
            <h2 style={{ fontSize: 24, fontWeight: 800, marginBottom: 8 }}>Editar Duração</h2>
            <p style={{ color: 'var(--text-secondary)', fontSize: 15, marginBottom: 28 }}>
      ...
      case 4:
        return (
          <div>
            <h2 style={{ fontSize: 22, fontWeight: 800, marginBottom: 6 }}>Editar Horário</h2>
            <p style={{ color: 'var(--text-secondary)', fontSize: 14, marginBottom: 24 }}>
